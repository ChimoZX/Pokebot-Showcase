...
* Reconocimiento Visual: Sistema de detección en tiempo real para identificar eventos específicos en pantalla (Shinies, encuentros, hordas).
* Navegación Autónoma: Motor de reproducción de rutas personalizadas con capacidad de grabación y lectura de waypoints.
* Módulos Especializados: Lógica separada para farmeo económico (Payday), caza de rarezas y actividades secundarias.
...
```text
Pokebot/
├── Configurations/    # Parámetros ajustables en tiempo real (JSON)
├── CoreLogic/         # Motor de visión, selección y utilidades
├── Modules/           # Lógica específica de cada tarea
├── Routing/           # Sistema de navegación y waypoints
└── main.py            # Orquestador de la interfaz gráfica
